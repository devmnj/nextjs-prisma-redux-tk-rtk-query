...
This is a Nextjs **Redux-toolkit** store for state management example with RTK query

The RTK Query will minimize the effort of creating a asyncThunk feature. RTK will autogenerate fuctions for us.
